...
# My Purchases & Refunds

Users can view all purchased courses with the following details for each: purchase date, amount, payment method, payment status, invoice download option, and a purchase details view.

**Purchase Details:**
- Shows purchased course information and allows eligible users to submit a refund request.
