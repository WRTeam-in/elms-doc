...
- **Switch to Student** – Access the student side of the platform.
- **Edit Profile** – Redirects to the common profile management page.
- **Dashboard, My Courses, and Earnings** – Quick navigation shortcuts.
- **Logout** – Securely signs out from the instructor panel.
