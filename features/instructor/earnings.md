...
Two withdrawal-related cards are available, each with their own detailed pages:

- **Available to Withdraw** – Displays the total amount currently eligible for withdrawal.
- **Total Withdrawn** – Displays the cumulative amount withdrawn to date.

Both cards include a **Withdraw** button that opens the withdrawal screen, where the instructor can enter an amount and submit a withdrawal request to their registered bank account. A table showing past withdrawal transactions and their statuses is also available.
