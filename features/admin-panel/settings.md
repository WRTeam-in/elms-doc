...
The System Settings section serves as the core configuration hub for your platform's brand identity, contact details, operational modes, and basic configurations. It is divided into the following sub-tabs:

### System Settings (Branding & Identity)

![System Settings](../../static/images/admin/system-settings.png)
...
![Contact Information](../../static/images/admin/contact_info.png)
...
![Other Settings](../../static/images/admin/other_settings.png)
...
![Commission Settings](../../static/images/admin/commision_settings.png)
...
![Instructor Mode Settings](../../static/images/admin/instructor_mode_settings.png)
...
![Social Links](../../static/images/admin/social_links.png)
...
![Email Configurations](../../static/images/admin/mail-settings.png)
...
![Firebase Settings](../../static/images/admin/firebase_settings.png)
...
![Refund Settings](../../static/images/admin/refund_settings.png)
...
![Instructor Terms](../../static/images/admin/instructor_terms_condition.png)
...
![App Settings](../../static/images/admin/app_settings.png)
...
![Payment Gateway Settings](../../static/images/admin/payment-gateway-settings.png)
...
![Store Credit Payment](../../static/images/admin/store-credit-payment-settings.png)
...
![Language Settings](../../static/images/admin/language-settings.png)
