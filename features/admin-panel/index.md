...
This section covers all features available to administrators and authorised staff managing the eLMS platform through the centralised web-based admin panel.
...
| [Student Activity](./student-activity) | Enrollment statistics, enrollment list with filtering, and detailed per-student learning progress tracking. |
| [Earnings & Transactions](./earnings-transactions) | Orders, payout requests, transactions, and tax report management with detailed views. |
| [Reports](./reports) | Sales, course, and instructor reports with date filtering and export options in PDF and Excel. |
| [Content](./content) | Manage home page sliders, FAQs, and other platform-wide content. |
